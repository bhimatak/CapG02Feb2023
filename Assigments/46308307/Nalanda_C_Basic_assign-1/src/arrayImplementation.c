/*This is a menu driven application which performs operations such as insert,sum of max and min element in the array ,count of a particular element and reversing the array.*/
