...
{
	int arr1[MAX_SIZE];
	int arr_size=0,ea=0,ele,ch,s,d;

	printf("\n\nEnter the size of array: ");
	scanf("%d",&arr_size);
	
	ea=arr_input(arr1,arr_size,MAX_SIZE);

	printf("\n\nEnter the number of elements to display (give <= %d):",ea);
	scanf("%d",&ele);

	arr_display(arr1,ele);
...
int arr_input(int arr[], int arr_size, int max_size)
{
	int i;
...
void arr_display(int arr[], int ds)
{
	int i;
