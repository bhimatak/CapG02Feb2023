/*Write an application that performs few operations on an interger array. Implement the
application by defining the functions given below. You can define an fixed size array in
