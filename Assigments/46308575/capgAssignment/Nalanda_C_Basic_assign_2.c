/*Write an application that performs few operations on a sentence. Implement the
application by defining the functions given below. You can define an fixed size
charater array in main function to hold the sentence.*/
