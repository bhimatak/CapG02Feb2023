/*Write an application that performs few operations on a sentence. Implement the application by defining the functions given below. You can define a fixed size character array in main function to hold the sentence.*/
